...
public class RController {
	...
	public String adminMain(HttpServletRequest request, HttpServletResponse response, Model model, HttpSession session)throws Exception
	{
		response.setContentType("text/html; charset=UTF-8");
	      request.setCharacterEncoding("UTF-8");
	        response.setCharacterEncoding("UTF-8");
	    ...
	    //로그인하지 않은 상태이면 로그인 화면으로 이동
	        return "redirect:/admin_login.ing";
	    }
	    */
	...
	@RequestMapping(value = "admin_marketList", method = RequestMethod.GET)
	public String admin_marketList(HttpServletRequest request, HttpServletResponse response, Model model)throws Exception
	{
		response.setContentType("text/html; charset=UTF-8");
	      request.setCharacterEncoding("UTF-8");
	        response.setCharacterEncoding("UTF-8");
		return "market/admin_marketList";
	}
	
	@RequestMapping(value = "product_list", method = RequestMethod.GET)
	public String product_list(HttpServletRequest request, HttpServletResponse response, Model model)throws Exception
	{
		response.setContentType("text/html; charset=UTF-8");
	      request.setCharacterEncoding("UTF-8");
	        response.setCharacterEncoding("UTF-8");
