...
<body>
	...
	<div id="right-panel" class="right-panel">
		...
		<form action="getList.do" method="get">
			...
			<select name="searchCondition" style="width: 80px; height: 33px;">
				<option value="" style="width: 80px; height: 33px;">선택</option>
				<option value="member" style="width: 80px; height: 33px;">회원</option>
				<option value="product" style="width: 80px; height: 33px;">상품</option>
				<option value="writer" style="width: 80px; height: 33px;">게시판</option>
			
			</select> <input type="text" name="searchkeyword" id="search"style="width: 500px; height: 33px;" /> 
								...
								<div class="stat-widget-five">
									...
									<div class="stat-content">
										<div class="text-left dib">
											...
											<div class="stat-heading">상품개수</div>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-lg-4">
									<div class="card-body">
										<div class="progress-box progress-1">
											<h4 class="por-title">전구</h4>
											<div class="por-txt">3건(30%)</div>
