...
<body>
	...
	<form id="admin_product_detail" name="admin_product_detail" method="post">
    	<input type='hidden' id='mar_num' name='mar_num' value='${board.m_num}' />
					<div class="card">
					<div class="card-header">
						<strong class="card-title">상품</strong>
					</div>
					<div class="card-body">
						...
						<tr align="center">            
                        <td><c:out value="${cart.m_num}"/></td>
                        <td><c:out value="${cart.cart_count}"/></td>
                        <td><c:out value="${cart.addDate}"/></td>
                        </tr>
						</c:forEach>
