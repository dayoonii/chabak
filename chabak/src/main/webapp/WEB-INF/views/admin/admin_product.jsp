               ...
               <div class="col-md-12">
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td ><c:out value="${result.mar_num }"/></td>     <!-- <td onClick='fn_view(${result.mar_num})' -->
                       
                        <td align="center">${result.mar_name }</td>
                  
                        <td><c:out value="${result.mar_content }"/></td>
                        <td>${result.mar_price}</td><%-- <c:out value="${result.mar_price }"/> --%>
...
function fn_view(mar_num){
      ...
      var url = "<c:url value='admin_marketForm_detail.do' />";
