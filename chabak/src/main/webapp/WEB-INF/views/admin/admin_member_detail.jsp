	...
	<div id="right-panel" class="right-panel">
		...
		<div class="tab-content">
			<div class="tab-pane fade show active" id="one">
				...
				<form id="admin_member_detail" name="admin_member_detail"
					method="post">
					...
					<div class="card">
						...
						<div class="card-body">
							<table id="bootstrap-data-table"
								...
								<tbody>
									<tr align="center">
										<td><c:out value="${result.m_name }" /></td>
										<td><c:out value="${result.m_id }" /></td>
										<td><c:out value="${result.m_email }" /></td>
										<td><c:out value="${result.m_address }" /></td>
										<td><c:out value="${result.m_point }" /></td>
								</tbody>
							</table>
						</div>
					</div>
								...
								<tbody>
									<tr align="center">
										<c:forEach var="board" items="${list1}" varStatus="status">
											<tr align="center">
												<td><c:out value="${board.cb_regdate}" /></td>
												<td><c:out value="${board.cb_title}" /></td>
												<td><c:out value="${board.cb_memo}" /></td>
											</tr>
										</c:forEach>
								</tbody>
							</table>
				...
				<div class="card">
					...
					<div class="card-body">
						<table id="bootstrap-data-table"
							...
							<tbody>
								<tr align="center">
									<c:forEach var="cart" items="${list1}" varStatus="status">
										<tr align="center">
											<td><c:out value="${board.cb_regdate}" /></td>
											<td><c:out value="${board.cb_title}" /></td>
											<td><c:out value="${board.cb_memo}" /></td>
