								...
								<table id="bootstrap-data-table"
									...
									<tbody>
										<c:forEach items="${list}" var="row">
											<tr>
												<td><a href='#' onClick='mem_view(${row.m_num})'>
														${row.m_num} </a></td>
												<td>
												...
												<input class="btn btn-secondary" type="submit" onClick="location.href='member_delete'" value="회원탈퇴">
												</form>
												</td>
...
<script type="text/javascript">
      $(document).ready(function() {
		...
		function mem_view(m_num){
          ...
          var url = "<c:url value='admin_member_detail.do' />";
          url = url + "?m_num=" + m_num;
